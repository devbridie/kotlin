...
public abstract class KotlinTemplateContextType extends TemplateContextType {
    ...
    public static class KotlinObject extends KotlinTemplateContextType {
        public KotlinObject() {
            super("KOTLIN_OBJECT", "Object in JVM module", Generic.class);
        }

        @Override
        protected boolean isInContext(@NotNull PsiElement element) {
            return isInClassOrObjectContext(element, KtObjectDeclaration.class);
        }
    }
    ...
    public static class Class extends KotlinTemplateContextType {
        ...
        @Override
        protected boolean isInContext(@NotNull PsiElement element) {
            return isInClassOrObjectContext(element, KtClassOrObject.class);
        }
    }
    ...
    private static boolean isInClassOrObjectContext(@NotNull PsiElement element, @NotNull java.lang.Class<?> klass) {
        PsiElement e = element;
